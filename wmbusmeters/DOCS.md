...
1. Add https://github.com/pawjensen/hassio-addon
1. Install Wmbusmeters
1. Plug-in your radio receiver USB dongle
1. Initial Configuration at the [Configuration](#configuration) tab
    1. Select data path (default is `/config/addon/wmbusmeter`)
...
1. Final configuration at the [Configuration](#configuration) tab
    1. [Set the device at the config](#section-wmbusmeters-configuration)
    1. [Configure the meters](#section-meters)
1. Finally, don't forget about adding the MQTT sensor into your Home Assistant or select `enable mqtt discovery`.
...
### Section: `wmbusmeters config location`
...
**Note** edit the configuration in the menu, and not the file `wmbusmeters.conf`.
...
**Note** edit the configuration in the menu, and not the meters files.
...
### Section: `Enable MQTT discovery`

Enable this to make it Home Assistant auto discovery the configurated meters.
...
This addon is a fork of the [wmbusmeters](https://github.com/wmbusmeters/wmbusmeters-ha-addon)
